...
import { updatePoolRiskScoreRequest, updatePoolRiskScoreResponse } from '../../models/validation/pool.validation';

export const updatePoolRiskScoreController = (servicesPlugin: ServicesPlugin) => {
  return new Elysia({ name: 'UpdatePoolRiskScoreController' }).use(servicesPlugin).post(
    '/updatePoolRiskScore',

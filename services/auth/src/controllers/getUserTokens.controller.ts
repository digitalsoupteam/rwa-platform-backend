...
import { getUserTokensRequest, getUserTokensResponse } from '../models/validation/user.validation';
import type { ServicesPlugin } from '../plugins/services.plugin';

export const createGetUserTokensController = (servicesPlugin: ServicesPlugin) => {
  return new Elysia({ name: 'GetUserTokensController' }).use(servicesPlugin).post(
    '/getUserTokens',

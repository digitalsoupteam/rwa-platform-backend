...
export const createServicesPlugin = (
  ...
  const contextService = withTraceSync(
    ...
    () => new ContextService(clientsPlugin.decorator.rwaClient, clientsPlugin.decorator.portfolioClient),
  );
  ...
  const plugin = withTraceSync('ai-assistant.init.services.plugin', () =>
